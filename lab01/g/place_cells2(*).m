        ...
        for r = 1:size(rdir,1)
            ...
            for m = 1:size(txys,1)
                ...
                for s = 1:size(tagspks,1)
                    ...
                    [~, ocmap, fmap, frmap, sfrmap] =  mkfrmap(spikes, txy, vertices.maze_centroid, video_sr, pix_per_cm,3); % quadrants
                    ...
                    save(tagspks(s).name,'spikes','spikes_xy','txy','ocmap','socmap','fmap','frmap','sfrmap','ips','smips','smspars','hist_xy','spars','video_sr','Mean_Frate','spk_high_speed','txy_high_speed','peakFR','spat_cohe','spat_coheR','n_pfields')%,spikes_xyQ...etc)
                    clear('spikes','spikes_xy','ocmap','socmap','fmap','frmap','sfrmap','ips','smips','smspars','hist_xy','spars','Mean_Frate','spk_high_speed','txy_high_speed','peakFR','spat_cohe','spat_coheR','n_pfields')
                end
